      ...
      <section>
        ...
        <div className="mt-5 flex justify-between items-center lg:flex-row flex-col">
          <div className="space-y-10 lg:w-1/2">
            ...
            <h1 className="text-2xl text-gray-400">Répartition des revenus</h1>
          </div>
          <div className="space-y-10  md:mb-10 ">
            <div className="lg:w-full h-64 mx-auto">
              <PieChart />
            </div>
            <h1 className="text-2xl text-gray-400">Répartition des depenses</h1>
          </div>
        </div>
      </section>
