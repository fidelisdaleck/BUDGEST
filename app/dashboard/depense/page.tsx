...
import AddDepense from "@/components/add-depense";

export default function Depense() {
  return (
    <div className="px-10">
      <div className="space-y-2 flex justify-between flex-col md:flex-row gap-3 md:gap-5">
        <div>
          <h1 className="text-4xl text-[#333333]">Historique des depense</h1>
